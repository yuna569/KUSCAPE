...
namespace Unity.MultiplayerCenterTests
{
    ...
    partial class RecommendationTests
    {
        ...
        [TestCase(PossibleSolution.LS, PossibleSolution.NGO, "NoCost", "Slow", "2", "4", "8" )]
        [TestCase(PossibleSolution.LS, PossibleSolution.NGO,"NoCost", "Fast", "2", "4", "8" )]
        [TestCase(PossibleSolution.LS, PossibleSolution.NGO,"BestMargin", "Slow", "2", "4", "8" )]   
        ...
        // Second line
        [TestCase(PossibleSolution.LS, PossibleSolution.NGO,"NoCost", "Slow", "16", "64+" )]
