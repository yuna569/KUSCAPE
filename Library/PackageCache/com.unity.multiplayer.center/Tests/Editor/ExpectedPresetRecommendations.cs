...
namespace Unity.MultiplayerCenterTests
{
    partial class RecommendationTests
    {
        ...
        public static IEnumerable<TestCaseData> SandboxPresetCases
            => new TestCaseData[]
            {
                new("2", PossibleSolution.NGO, PossibleSolution.LS, Preset.Sandbox),
                new("4", PossibleSolution.NGO, PossibleSolution.LS, Preset.Sandbox),
                new("8", PossibleSolution.NGO, PossibleSolution.LS, Preset.Sandbox),
        ...
        public static IEnumerable<TestCaseData> SimulationPresetCases
            => new TestCaseData[]
            {
                new("2", PossibleSolution.NGO, PossibleSolution.LS, Preset.Simulation),
                new("4", PossibleSolution.NGO, PossibleSolution.LS, Preset.Simulation),
                new("8", PossibleSolution.NGO, PossibleSolution.LS, Preset.Simulation),
                new("16", PossibleSolution.NGO, PossibleSolution.LS, Preset.Simulation),
                new("64+", PossibleSolution.NGO, PossibleSolution.LS, Preset.Simulation),
